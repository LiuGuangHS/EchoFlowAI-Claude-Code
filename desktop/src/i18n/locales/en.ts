export const en = {
  ...
  'settings.activity.defaultHandle': 'EchoFlow Code',
  ...
  'settings.terminal.description': 'Run host-machine commands for plugin, skill, and MCP setup. The desktop app includes echoflow-code; replace documented claude <args> with echoflow-code <args>, for example: echoflow-code plugin install ... or echoflow-code mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Clears only: echoflow-code-open-tabs, echoflow-code-session-runtime, echoflow-code-theme, echoflow-code-locale, echoflow-code-app-zoom, and echoflow-code.persistence.schemaVersion.',
  ...
  'settings.echoflowAPIOfficialLogin.connectModeTitle': 'Connection mode',
  'settings.echoflowAPIOfficialLogin.connectModeManagementToken': 'Management token (recommended)',
  'settings.echoflowAPIOfficialLogin.connectModeManualKey': 'Existing API key (basic)',
  'settings.echoflowAPIOfficialLogin.manualKeyDesc': 'Basic model calls only — no balance check or model list',
  'settings.echoflowAPIOfficialLogin.managementTokenPlaceholder': 'Paste your management token',
  'settings.echoflowAPIOfficialLogin.validateToken': 'Verify token',
  'settings.echoflowAPIOfficialLogin.validating': 'Verifying...',
  'settings.echoflowAPIOfficialLogin.balance': 'Balance',
  'settings.echoflowAPIOfficialLogin.userGroup': 'Group',
  'settings.echoflowAPIOfficialLogin.selectMainModel': 'Main model',
  'settings.echoflowAPIOfficialLogin.selectHaikuModel': 'Fast model (haiku)',
  'settings.echoflowAPIOfficialLogin.modelFetchFailed': 'Could not fetch model list, using defaults',
  'settings.echoflowAPIOfficialLogin.goRegister': 'Register EchoFlowAPI',
  'settings.echoflowAPIOfficialLogin.goGetToken': 'Get management token',
  'settings.echoflowAPIOfficialLogin.tokenInvalid': 'Token invalid or expired — please regenerate',
  'settings.echoflowAPIOfficialLogin.serviceUnavailable': 'Unable to reach EchoFlowAPI right now. Please try again later.',
  'settings.echoflowAPIOfficialLogin.compatibilityNote': 'This version temporarily uses the management token to finish call setup; once project key creation is stable, it will create and save a scoped project key instead.',
  'settings.echoflowAPIOfficialLogin.managementTokenGuide': 'Go to EchoFlowAPI dashboard → Profile → Security → Management tokens → Generate',
  'settings.echoflowAPIOfficialLogin.manualKeyPlaceholder': 'Enter API key / app code',
  'settings.echoflowAPIOfficialLogin.mainModelPlaceholder': 'Main model ID (required)',
  'settings.echoflowAPIOfficialLogin.haikuModelPlaceholder': 'Fast model ID (leave blank = same as main)',
  ...
  'settings.providers.echoflowAPIOfficialName': 'EchoFlowAPI (Qingyun API)',
  'settings.providers.echoflowAPIOfficialDesc': 'Official gateway to 500+ models — Claude / OpenAI-compatible, stable in China',
  ...
  'settings.providers.settingsJsonDesc': '<EchoFlow AppData>/echoflow/settings.json — edit directly, will be written on save.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for EchoFlow Code data',
  ...
  'settings.general.storageMoveHint': 'Switching directories does not migrate existing data. Copy projects, skills, plugins, echoflow, and related folders from the old directory if you want old sessions to keep appearing. For a portable bundle, keep this folder beside the app and zip them together.',
  ...
  'settings.general.legacyMigrationTitle': 'Import from older versions',
  'settings.general.legacyMigrationDescription': 'Check older configuration and copy it into the current EchoFlow data directory. Current data is not overwritten, and older data is not deleted.',
  'settings.general.legacyMigrationCheck': 'Check Legacy Data',
  'settings.general.legacyMigrationImport': 'Import Legacy Data',
  'settings.general.legacyMigrationReadyCount': '{count} ready to import',
  'settings.general.legacyMigrationExistsCount': '{count} already exist',
  'settings.general.legacyMigrationMissingCount': '{count} not found',
  'settings.general.legacyMigrationFailedCount': '{count} abnormal',
  'settings.general.legacyMigrationConfirmTitle': 'Import legacy data?',
  'settings.general.legacyMigrationConfirmBody': 'Configuration will be copied from older version directories into the current EchoFlow data directory. Existing current data will not be overwritten, and older data will not be deleted.',
  'settings.general.legacyMigrationSuccess': 'Legacy data imported. New sessions will use the imported provider configuration; running sessions are not affected.',
  'settings.general.legacyMigrationFailed': 'Legacy data import failed: {error}',
  'settings.general.legacyMigrationNoData': 'No importable legacy data found.',
  ...
  'settings.general.notificationsTestTitle': 'EchoFlow Code notifications are enabled',
